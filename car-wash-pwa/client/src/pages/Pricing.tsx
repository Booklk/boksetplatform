...
const faqs = [
  ...
  { q: 'هل Jdawil يأخذ عمولة على المدفوعات؟', a: 'لا. المال يدخل حسابك البنكي مباشرة. Jdawil لا يلمس أموالك.' },
  { q: 'أقدر أغير الباقة لاحقاً؟', a: 'نعم، تقدر ترقّي أو تنزّل باقتك في أي وقت من إعدادات حسابك.' },
  { q: 'هل يدعم أكثر من نوع خدمة؟', a: 'نعم، Jdawil يدعم مغاسل سيارات، صالونات، تنظيف منازل، صيانة، تجميل، فري لانسر، وأي نوع خدمة.' },
];
  ...
  return (
    <MarketingLayout>
      <Helmet>
        ...
        <link rel="canonical" href="https://jdawil.sa/pricing" />
      </Helmet>
