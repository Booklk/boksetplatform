...
const vendorNavSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/vendor/addons', icon: ShoppingBag, label: 'الإضافات' },
...
const superAdminNavSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { to: '/super-admin/profitability', icon: DollarSign, label: 'الربحية' },
      { to: '/super-admin/billing-audit', icon: FileText, label: 'سجل الأحداث المالية' },
