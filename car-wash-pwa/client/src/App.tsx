...
const VendorWhatsApp = lazy(() => import('./pages/vendor/WhatsApp'));
...
function AppRoutes() {
  ...
  return (
    ...
    <Routes location={location} key={location.pathname}>
        ...
        <Route path="/vendor/whatsapp" element={
          <RequireAuth roles={['vendor_admin', 'admin']}>
            <S><VendorWhatsApp /></S>
          </RequireAuth>
        } />
        ...
        <Route path="/vendor/media-studio" element={
          <RequireAuth roles={['vendor_admin', 'admin']}>
            <S><VendorMediaStudio /></S>
          </RequireAuth>
        } />
        <Route path="/vendor/preferences" element={
          <RequireAuth roles={['vendor_admin', 'admin']}>
            <S><VendorPreferences /></S>
          </RequireAuth>
        } />
